      ...
      {open && (
        ...
        >
          <p className="text-xs text-zinc-500">
            Create a user account directly (bypasses the public request form). They&apos;ll receive
            an email with their temporary password and a sign-in link. They must change their
